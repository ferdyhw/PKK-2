...
<html lang="en">
<head>
  <title>KELAS IOT | HELP</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="icon" type="image/x-icon" href="../img/favicon.ico">
  <link rel="stylesheet" href="../css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="../style/style_10.css">
...
<nav class="navbar sticky-top navbar-expand-md bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item4">
        <a class="nav-link" style="color: #16a085;" href="login">LOGIN</a>
      </li>
    </ul>
</nav>
...
<div class="jumbotron">
    <div class="container">
      <h1 class="display-4">Butuh Bantuan Brad ?</h1>
      <p class="gb_1" style="text-align: justify;">
